...
/** \brief Calls the provided function once for each element in an array, in order.
 * \param pList ArrayList* Pointer to arrayList
 * \param pFunc (*pFunc) Pointer to fuction to be run for each element in the array.
 * \return A new array with the results of calling a function for every array element.
 *
 */
...
/** \brief Creates an array filled with all array elements that pass a test (provided as a function).
 *
 * \param pList ArrayList* Pointer to arrayList.
 * \param A function to be run for each element in the array.
